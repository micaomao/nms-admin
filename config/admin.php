...
return [
    ...
    'auth' => [
        ...
        'providers'        => [
            'admin' => [
                'driver' => 'eloquent',
                'model'  => \Micaomao\NmsAdmin\Models\AdminUser::class,
            ],
        ],
        'except'           => [
    ...
    'models' => [
        'admin_user'       => \Micaomao\NmsAdmin\Models\AdminUser::class,
        'admin_role'       => \Micaomao\NmsAdmin\Models\AdminRole::class,
        'admin_menu'       => \Micaomao\NmsAdmin\Models\AdminMenu::class,
        'admin_permission' => \Micaomao\NmsAdmin\Models\AdminPermission::class,
    ],
