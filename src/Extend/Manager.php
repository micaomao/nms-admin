...
use Micaomao\NmsAdmin\Support\Zip;
use Illuminate\Support\Collection;
use Micaomao\NmsAdmin\Support\Helper;
use Illuminate\Filesystem\Filesystem;
use Micaomao\NmsAdmin\Support\Composer;
use Illuminate\Contracts\Container\Container;
use Psr\Container\NotFoundExceptionInterface;
use Psr\Container\ContainerExceptionInterface;
use Micaomao\NmsAdmin\Models\Extension as ExtensionModel;
...
class Manager
{
    ...
    public function resolveExtension(string $directory, bool $addPsr4 = true)
    {
        ...
        $serviceProvider = $composerProperty->get('extra.nms-admin');
    ...
    protected function checkFiles($directory)
    {
        ...
        if (!$composerProperty->name || !$composerProperty->get('extra.nms-admin')) {
            return false;
        }
