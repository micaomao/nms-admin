...
namespace Micaomao\NmsAdmin\Console;
...
class PublishCommand extends Command
{
     ...
     * @var string
     */
    protected $description = "Re-publish nms-admin's assets, configuration and language files. If you want overwrite the existing files, you can add the `--force` option";
