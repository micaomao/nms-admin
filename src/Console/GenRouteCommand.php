...
use Micaomao\NmsAdmin\Support\CodeGenerator\ControllerGenerator;
...
// =====================================================================
// !!  路由文件由 nms-admin 自动生成，请不要手动修改。
// !!  Route file auto generated by nms-admin, don't modify it manually.
// =====================================================================
...
EOF;
        ...
        AdminApiService::make()->query()->where('enabled', 1)->get()->map(function ($item) use (&$routes) {
            ...
            $routes .= <<<EOF
    // {$item->title}
    \$router->{$item->method}('{$_route}', [\Micaomao\NmsAdmin\Controllers\AdminApiController::class, 'index']);
