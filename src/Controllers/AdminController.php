...
use Micaomao\NmsAdmin\Traits;
use Illuminate\Http\JsonResponse;
use Illuminate\Routing\Controller;
use Micaomao\NmsAdmin\Services\AdminService;
...
abstract class AdminController extends Controller
{
     ...
     * 获取当前登录用户
     *
     * @return \Illuminate\Contracts\Auth\Authenticatable|\Micaomao\NmsAdmin\Models\AdminUser|null
     */
     ...
     * 后台响应
     *
     * @return \Micaomao\NmsAdmin\Support\Cores\JsonResponse
     */
